...
if(${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
  set(GAME_OS_WINDOWS 1)
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
  set(GAME_OS_LINUX 1)
elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
  set(GAME_OS_MACOS 1)
elseif(CMAKE_SYSTEM_NAME MATCHES "^k?FreeBSD$")
  set(GAME_OS_FREEBSD 1)
elseif(CMAKE_SYSTEM_NAME MATCHES "^OpenBSD$")
  set(GAME_OS_OPENBSD 1)
elseif(CMAKE_SYSTEM_NAME MATCHES "^NetBSD$")
  set(GAME_OS_NETBSD 1)
else()
...
if(MSVC)
  set(GAME_COMPILER_MSVC 1)
  # Identify if we are using clang-CL
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    set(GAME_COMPILER_CLANG_CL 1)
  endif()

elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  set(GAME_COMPILER_CLANG 1)
elseif (CMAKE_CXX_COMPILER_ID MATCHES "IntelLLVM")
  set(GAME_COMPILER_INTEL 1)
elseif (CMAKE_CXX_COMPILER_ID MATCHES "NVHPC")
  set(GAME_COMPILER_NVIDIA_HPC 1)
elseif(CMAKE_COMPILER_IS_GNUCXX)
  set(GAME_COMPILER_GCC 1)

  execute_process(COMMAND "${CMAKE_CXX_COMPILER}" "--version" OUTPUT_VARIABLE GCC_COMPILER_VERSION)
  string(REGEX MATCHALL ".*(tdm[64]*-[1-9]).*" GAME_COMPILER_GCC_TDM "${GCC_COMPILER_VERSION}")
else()
